...
if (empty($_SESSION['staff_user_id'])) {
    ...
    header('Location: ' . $baseUrl . '/index.php?page=login&redirect=' . urlencode('staff'));
    exit;
}
...
// Metriche live
// -----------------------------------------------------------------------------
$metrics = ['titoli' => 0, 'prestiti' => 0, 'in_scadenza' => 0, 'utenti_attivi' => 0];

try {
    $metrics['titoli'] = (int) $pdo->query('SELECT COUNT(*) FROM biblio')->fetchColumn();
    ...
    <header class="staff-header">
        <div class="staff-header-top">
            ...
            <div class="staff-current-user">
                ...
                <a class="staff-logout-link" href="<?= h($baseUrl) ?>/index.php?page=staff_logout">Esci</a>
            </div>
        </div>
    </header>
            ...
            <ul class="staff-card-list">
                ...
                <li class="staff-card-item staff-card-item--active">
                    <div class="staff-card-item-body">
                        <a href="<?= h($baseUrl) ?>/index.php?page=staff_catalog_new">Inserisci nuovo record</a>
                        <p class="staff-card-note">Pagina unificata con quattro metodi: manuale, da SBN, da file MARC21/EndNote, da MARCXML.</p>
                    </div>
                </li>
                ...
                <li class="staff-card-item staff-card-item--active">
                    <div class="staff-card-item-body">
                        ...
                        <p class="staff-card-note">Ricerca avanzata con filtri per collocazione, collezione e soggetti MARC. Accesso diretto alla modifica di ogni record.</p>
                    </div>
                </li>
                ...
                <li class="staff-card-item staff-card-item--active">
                    <div class="staff-card-item-body">
                        ...
                        <p class="staff-card-note">Recupera automaticamente il riassunto (MARC 520 $a) per i record con ISBN privi di descrizione. Fonti: SBN → OpenLibrary → Google Books.</p>
                    </div>
                </li>

                <li class="staff-card-item staff-card-item--active">
                    <div class="staff-card-item-body">
                        <a href="<?= h($baseUrl) ?>/index.php?page=staff_sbn">Arricchimento da SBN per ISBN</a>
                        <p class="staff-card-note">Recupera autore, editore, anno e BID dal Catalogo Unico SBN per i record con ISBN.</p>
                    </div>
                </li>

                <li class="staff-card-item staff-card-item--active">
                    <div class="staff-card-item-body">
                        <a href="<?= h($baseUrl) ?>/index.php?page=staff_sbn_enrich_title">Arricchimento da SBN per titolo</a>
                        <p class="staff-card-note">Cerca record senza BID SBN per titolo, scegli il match corretto e arricchisci con autore, editore, Dewey, soggetti, ecc.</p>
                    </div>
                </li>
            ...
            <ul class="staff-card-list">
                ...
                <li class="staff-card-item staff-card-item--active">
                    <div class="staff-card-item-body">
                        ...
                        <p class="staff-card-note">Crea un operatore con username, email e permessi.</p>
                    </div>
                </li>
