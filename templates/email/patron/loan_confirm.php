        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #ddd;border-radius:4px">
          ...
          <tr>
            <td style="padding:24px 24px 16px 24px">
              <h2 style="margin:0 0 14px 0;color:#222;font-size:20px">Prestito registrato</h2>

              <p style="margin:0 0 16px 0;color:#444;line-height:1.6">
                Ciao<?= ($name ?? '') !== '' ? ' <strong>' . h((string)$name) . '</strong>' : '' ?>, il tuo prestito è stato registrato.
              </p>
              ...
              <table cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse;margin-bottom:20px">
                ...
                <?php endif; ?>
                <tr style="border-bottom:1px solid #eee">
                  <td style="padding:9px 0;color:#666;font-size:14px">Barcode copia</td>
                  <td style="padding:9px 0;color:#222;font-size:14px"><?= h((string)($copyBarcode ?? '')) ?></td>
                </tr>
                <tr>
                  <td style="padding:9px 0;color:#666;font-size:14px">Da restituire entro</td>
                  <td style="padding:9px 0;font-size:14px"><strong style="color:#b00020"><?= h((string)($dueDate ?? '')) ?></strong></td>
                </tr>
              </table>

              <p style="margin:0 0 10px 0;color:#666;font-size:13px;line-height:1.5">
                Ricorda di restituire il volume entro la data indicata. In caso di necessità puoi richiedere il rinnovo presso la biblioteca.
              </p>
